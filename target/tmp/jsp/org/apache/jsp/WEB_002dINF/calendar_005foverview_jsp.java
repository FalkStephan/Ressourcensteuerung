 ...
 * Generated at: 2025-09-16 12:05:55 UTC
...
public final class calendar_005foverview_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                    <label><input type=\"checkbox\" name=\"view\" value=\"availability_percent\"> Team-Verfügbarkeit</label>\n");
      ...
      out.write("        });\n");
      out.write("        // KORREKTUR: Event-Listener wird sicher an den Tabellenkörper gehängt\n");
      ...
      out.write("            // console.log('Info Employee.Tag:', dateString);\n");
      ...
      out.write("                        };\n");
      out.write("                        \n");
      out.write("                        // console.log(`TREFFER: `, activeCapacity);\n");
      ...
      out.write("\n");
      out.write("        /**\n");
      out.write("        * NEUE FUNKTION: Berechnet die Verfügbarkeit eines Mitarbeiters für einen bestimmten Tag.\n");
      out.write("        */\n");
      ...
      out.write("\n");
      out.write("\n");
      out.write("        function countWorkdays(startDateStr, endDateStr, holidays) {\n");
      out.write("            /**\n");
      ...
      out.write("\n");
      out.write("                if (dayOfWeek > 0 && dayOfWeek < 6 && !holidaySet.has(dateStr)) {\n");
      out.write("                    count++;\n");
      out.write("                }\n");
      ...
      out.write("            if (!employee.tasks) return 0;\n");
      out.write("\n");
      out.write("            const currentDay = new Date(day.date + \"T12:00:00\");\n");
      out.write("\n");
      out.write("            employee.tasks.forEach(task => {\n");
      ...
      out.write("                    const workdays = countWorkdays(task.start_date, task.end_date, holidays);\n");
      ...
      out.write("            }\n");
      out.write("\n");
      out.write("            // KORREKTUR: Daten direkt aus dem 'data-*'-Attribut der angeklickten Zeile holen\n");
      ...
      out.write("                noTasksRow.innerHTML = `<td colspan=\"100%\" class=\"employee-name task-detail-name\" style=\"font-style: italic;\">Keine Aufgaben für diesen Mitarbeiter im Zeitraum gefunden.</td>`;\n");
      ...
      out.write("                document.getElementById('currentMonth').textContent = monthNames[currentDate.getMonth()] + ' ' + currentDate.getFullYear();\n");
      out.write("\n");
      ...
      out.write("\n");
      out.write("                // console.log('Vom Server erhaltene Daten:', data); \n");
      out.write("\n");
      ...
      out.write("                        // 1. Hauptzeile für den Mitarbeiter erstellen (wie bisher)\n");
      ...
      out.write("                            employeeTaskRow.dataset.holidays = JSON.stringify(holidays);\n");
      ...
      out.write("                            data.days.forEach(day => {\n");
      out.write("                                const td = document.createElement('td');\n");
      out.write("                                const taskeffort = getTaskEffortForDate(day, employee, holidays);\n");
      ...
      out.write("                    });\n");
      out.write("\n");
      out.write("                    // 3. Die Summenzeile erstellen\n");
      ...
      out.write("\n");
      out.write("                    const summaryLabelCell = document.createElement('td');\n");
      out.write("                    summaryLabelCell.textContent = 'Team-Verfügbarkeit';\n");
      out.write("                    summaryLabelCell.classList.add('employee-name', 'summary-label');\n");
      out.write("                    summaryRow.appendChild(summaryLabelCell);\n");
      out.write("\n");
      out.write("                    // 4. Zellen für jede Tagessumme erstellen und füllen\n");
