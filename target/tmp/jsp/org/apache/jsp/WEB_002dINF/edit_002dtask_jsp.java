 ...
 * Generated at: 2025-10-27 09:35:51 UTC
...
public final class edit_002dtask_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("                    <div>\n");
      out.write("                        <label for=\"task_options\">Verfügbarkeits-Option</label>\n");
      out.write("                        <select id=\"task_options\" name=\"task_options\" class=\"form-control\">\n");
      out.write("                            <option value=\"waiting\" ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${task.task_options == 'waiting' ? 'selected' : ''}", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write(">\n");
      out.write("                                Aufgabe wartet auf Verfügbarkeit\n");
      out.write("                            </option>\n");
      out.write("                            <option value=\"continue\" ");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${task.task_options == 'continue' ? 'selected' : ''}", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write(">\n");
      out.write("                                Aufgabe fällt auch an, wenn keine Verfügbarkeit vorhanden\n");
      out.write("                            </option>\n");
      out.write("                        </select>\n");
      out.write("                    </div>\n");
      out.write("\n");
      out.write("                    <div>\n");
      out.write("                        <label for=\"description\">Beschreibung:</label>\n");
      out.write("                        <textarea id=\"description\" name=\"description\" class=\"form-control\" rows=\"3\" style=\"resize: vertical; width: 100%;\">");
      ...
      out.write("                    <button type=\"button\" id=\"saveAsCopyBtn\" class=\"button\" onclick=\"saveAsCopy()\">Als Kopie speichern</button>\n");
      ...
      out.write("        // console.log('Aufruf der Seite.....');\n");
      out.write("        if (taskId) {\n");
      out.write("            // console.log('TaskId laden: ', taskId);\n");
      out.write("            loadAssignedUsers(taskId);\n");
      out.write("        }\n");
      out.write("        else {\n");
      out.write("            // console.log('neue TaskId!');\n");
      out.write("            // 1. Fortschritt auf 0 setzen\n");
      out.write("            const progressInput = document.getElementById('taskProgress');\n");
      out.write("            if (progressInput) {\n");
      out.write("                progressInput.value = 0;\n");
      out.write("            }\n");
      out.write("\n");
      out.write("            // 1. Aufwand auf 0 setzen\n");
      out.write("            const effortInput = document.getElementById('taskEffort');\n");
      out.write("            if (effortInput) {\n");
      out.write("                effortInput.value = 0;\n");
      out.write("            }\n");
      out.write("\n");
      out.write("            // 2. Start-Datum auf das heutige Datum setzen\n");
      out.write("            const startDateInput = document.getElementById('taskStartDate');\n");
      out.write("            if (startDateInput) {\n");
      out.write("                const today = new Date();\n");
      out.write("                // Formatiert das Datum in 'YYYY-MM-DD' für das <input type=\"date\">-Feld\n");
      out.write("                const formattedDate = today.getFullYear() + '-' + ('0' + (today.getMonth() + 1)).slice(-2) + '-' + ('0' + today.getDate()).slice(-2);\n");
      out.write("                startDateInput.value = formattedDate;\n");
      out.write("            }\n");
      out.write("        }\n");
      out.write("        \n");
      ...
      out.write("                // console.log('Task-ID nach dem Speichern:', taskId);\n");
      out.write("                \n");
      ...
      out.write("                }\n");
      out.write("                // console.log('Task-ID: ', taskId);\n");
      out.write("                \n");
      out.write("                if (!taskId) {\n");
      ...
      out.write("                // console.log('User: ', assignedUsers);\n");
      ...
      out.write("            }\n");
      out.write("            // console.log('User:', users);\n");
      out.write("\n");
      out.write("\n");
      out.write("            assignedUsers = users.map(user => ({\n");
      out.write("                id: user.user_id,\n");
      ...
      out.write("            // console.log ('Prüfung1: ', userId);\n");
      out.write("            // console.log ('Prüfung2: ', assignedUsers);\n");
      ...
      out.write("            effortInput.step = '0.1';\n");
      ...
      out.write("    }\n");
      out.write("\n");
      out.write("    // Speichert die Zuweisungen (assignedUsers) für eine gegebene taskId\n");
      out.write("    async function saveAssignmentsForTask(taskId) {\n");
      out.write("        if (!taskId) return;\n");
      out.write("        if (!assignedUsers || assignedUsers.length === 0) return;\n");
      out.write("\n");
      out.write("        const assignments = new URLSearchParams();\n");
      out.write("        assignments.append('action', 'saveAssignments');\n");
      out.write("        assignments.append('taskId', taskId);\n");
      ...
      out.write("            assignments.append(`effortDays_");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${index}", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("`, (user.effort_days || 0).toString());\n");
      out.write("        });\n");
      out.write("\n");
      ...
      out.write("    }\n");
      out.write("\n");
      out.write("    // Speichert die aktuelle Aufgabe als neue Kopie (Name + \" (Kopie)\") inkl. Zuweisungen\n");
      out.write("    async function saveAsCopy() {\n");
      out.write("        try {\n");
      out.write("            const form = document.getElementById('taskForm');\n");
      out.write("            const formData = new URLSearchParams(new FormData(form));\n");
      out.write("\n");
      out.write("            // Erzwinge 'add' und entferne vorhandene ID\n");
      out.write("            formData.set('action', 'add');\n");
      out.write("            formData.delete('id');\n");
      out.write("\n");
      out.write("            // Name mit \"(Kopie)\" ergänzen\n");
      out.write("            const originalName = formData.get('name') || '';\n");
      out.write("            const copySuffix = ' (Kopie)';\n");
      out.write("            const newName = originalName.endsWith(copySuffix) ? originalName : (originalName + copySuffix);\n");
      out.write("            formData.set('name', newName);\n");
      out.write("\n");
      out.write("            const response = await fetch('tasks', {\n");
      out.write("                method: 'POST',\n");
      out.write("                headers: {\n");
      ...
      out.write("            let json;\n");
      out.write("            try { json = JSON.parse(text); } catch (e) { throw new Error('Ungültige Server-Antwort beim Anlegen der Kopie'); }\n");
      out.write("\n");
      out.write("            if (!response.ok) {\n");
      out.write("                throw new Error('Fehler beim Anlegen der Kopie: ' + (json.error || text));\n");
      out.write("            }\n");
      out.write("\n");
      out.write("            const newTaskId = json.taskId;\n");
      out.write("            if (!newTaskId) throw new Error('Keine neue Task-ID empfangen');\n");
      out.write("\n");
      out.write("            // Zuweisungen für die neue Task speichern\n");
      out.write("            await saveAssignmentsForTask(newTaskId);\n");
      out.write("\n");
      out.write("            // Seite \"edit-task\" für die neue Task öffnen\n");
      out.write("            window.location.href = 'tasks?action=edit&id=' + encodeURIComponent(newTaskId);\n");
      out.write("            \n");
      out.write("            // Weiterleitung zur Aufgabenliste\n");
      out.write("            // window.location.href = 'tasks';\n");
      out.write("        } catch (err) {\n");
      out.write("            alert(err.message || 'Fehler beim Speichern der Kopie');\n");
      out.write("        }\n");
      out.write("    }\n");
      out.write("</script>\n");
      out.write("\n");
  ...
  private boolean _jspx_meth_c_005fout_005f0(jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/edit-task.jsp(136,139) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fout_005f0.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${task.description}", java.lang.Object.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_005fforEach_005f1(jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/edit-task.jsp(164,12) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f1.setVar("user");
      // /WEB-INF/edit-task.jsp(164,12) name = items type = jakarta.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f1.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/edit-task.jsp(164,12) '${availableUsers}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${availableUsers}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
