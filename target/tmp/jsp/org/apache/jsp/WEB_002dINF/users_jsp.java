 ...
 * Generated at: 2025-07-31 07:19:14 UTC
...
static {
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("                <button type=\"button\" class=\"button create\" \n");
      out.write("onclick=\"showUserForm('add')\">Neuen Benutzer anlegen</button>\n");
      out.write("                <button type=\"button\" class=\"button create\" style=\"margin-left:1em;\"\n");
      out.write("onclick=\"showImportModal()\">Benutzer importieren</button>\n");
      out.write("                <a href=\"");
      ...
      out.write("                            <input type=\"checkbox\" name=\"import_new\" id=\"importNew\" checked>\n");
      out.write("                     \n");
      out.write("        neue Benutzer importieren\n");
      out.write("                        </label>\n");
      out.write("                        <label style=\"display:block; margin-bottom:0.5em;\">\n");
      out.write("                            <input type=\"checkbox\" name=\"update_existing\" id=\"updateExisting\" checked>\n");
      out.write("         \n");
      out.write("                    bestehende Benutzer aktualisieren\n");
      out.write("                        </label>\n");
      out.write("                        <label style=\"display:block;\">\n");
      out.write("                            <input type=\"checkbox\" \n");
      out.write("name=\"deactivate_missing\" id=\"deactivateMissing\">\n");
      out.write("                            nicht enthaltene Benutzer deaktivieren\n");
      out.write("                        </label>\n");
      out.write("                    </div>\n");
      ...
      out.write("                        <a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/resources/Muster.xlsx\" download class=\"button\" style=\"background:#007bff;\n");
      out.write(" color:#fff;\">Musterdatei herunterladen</a>\n");
      ...
      out.write("                <div \n");
      out.write(" class=\"modal-buttons\" style=\"margin-top:1em;\">\n");
      ...
      out.write("                    <input type=\"text\" id=\"userSearch\" \n");
      out.write(" onkeyup=\"filterTable()\" placeholder=\"Benutzer suchen...\">\n");
      ...
      out.write("                                <label><input type=\"checkbox\" class=\"col-toggle\" data-col=\"5\" \n");
      out.write(" checked> Team</label>\n");
      ...
      out.write("                            <th \n");
      out.write(" class=\"sortable-header\" onclick=\"sortTable(7, 'string')\">Logbuch</th>\n");
      ...
      out.write("                            <input type=\"text\" id=\"userFormName\" name=\"name\" \n");
      out.write(" required />\n");
      out.write("                        </div>\n");
      out.write("                    </div>\n");
      out.write("                    <div style=\"display: flex;\n");
      ...
      out.write("                    </div>\n");
      out.write("                    <div style=\"display: flex;\n");
      out.write(" gap: 1em; align-items: center;\">\n");
      out.write("                        <div style=\"flex:1;\">\n");
      ...
      out.write("                       \n");
      out.write("     <label for=\"userFormPassword\">Passwort<span class=\"required-star\">*</span>:</label>\n");
      out.write("                            <input type=\"password\" id=\"userFormPassword\" name=\"password\" required />\n");
      out.write("                        </div>\n");
      out.write("                    </div>\n");
      out.write("                \n");
      out.write("     <div style=\"margin-top: 1em;\" id=\"rechteFieldWrapper\">\n");
      out.write("                        <label style=\"display: block; margin-bottom: 10px;\">Rechte:</label>\n");
      out.write("                        <label for=\"userFormCanManageUsers\" style=\"margin-left: 2em;\">\n");
      out.write("                            <input type=\"checkbox\" id=\"userFormCanManageUsers\" name=\"can_manage_users\"> Benutzerverwaltung\n");
      out.write("                        </label>\n");
      out.write("                  \n");
      out.write("                        <label for=\"userFormCanViewLogbook\" style=\"margin-left: 2em;\">\n");
      out.write("                            <input type=\"checkbox\" id=\"userFormCanViewLogbook\" name=\"can_view_logbook\"> Logbuch\n");
      out.write("                        </label>\n");
      out.write("\n");
      out.write("                        <label for=\"userFormCanManageFeiertage\" style=\"margin-left: 2em;\">\n");
      out.write("                            <input type=\"checkbox\" id=\"userFormCanManageFeiertage\" name=\"can_manage_feiertage\"> Feiertage verwalten\n");
      out.write("                        </label>\n");
      out.write("                    </div>\n");
      out.write("               \n");
      ...
      out.write("            \n");
      out.write("            // GEÄNDERT: Das Formular wird immer an den UserServlet gesendet\n");
      ...
      out.write("                document.getElementById('userFormId').value = '';\n");
      out.write("                document.getElementById('userFormUsername').value = '';\n");
      out.write("                document.getElementById('userFormName').value = '';\n");
      out.write("                document.getElementById('userFormVorname').value = '';\n");
      out.write("                document.getElementById('userFormStelle').value = '';\n");
      out.write("                document.getElementById('userFormTeam').value = '';\n");
      out.write("                document.getElementById('userFormPassword').value = '';\n");
      out.write("                document.getElementById('userFormCanManageUsers').checked = false;\n");
      out.write("                document.getElementById('userFormCanManageFeiertage').checked = false;\n");
      out.write("                document.getElementById('userFormCanViewLogbook').checked = false;\n");
      out.write("                document.getElementById('userFormAbteilung').value = '';\n");
      ...
      out.write("                document.getElementById('userFormPassword').value = '';\n");
      out.write("                document.getElementById('userFormCanManageUsers').checked = (btn.dataset.can_manage_users === 'true');\n");
      out.write("                document.getElementById('userFormCanManageFeiertage').checked = (btn.dataset.can_manage_feiertage === 'true');\n");
      out.write("                document.getElementById('userFormCanViewLogbook').checked = (btn.dataset.can_view_logbook === 'true');\n");
      ...
      out.write("                const isUserVal = btn.dataset.is_user;\n");
      out.write("                document.getElementById('userFormIsUser').checked = (isUserVal === 'true' || isUserVal === true || isUserVal === 1 || isUserVal === '1');\n");
      out.write("                toggleUserFields();\n");
      out.write("            }\n");
      ...
      out.write("            document.getElementById('userFormPassword').required = isUser;\n");
      out.write(" }\n");
      out.write("        // Initial beim Öffnen Modal setzen:\n");
      out.write("        document.addEventListener('DOMContentLoaded', function() {\n");
      out.write("            if (document.getElementById('userFormIsUser')) {\n");
      out.write("                toggleUserFields();\n");
      out.write("            }\n");
      out.write("        });\n");
  ...
  private boolean _jspx_meth_c_005fset_005f0(jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/users.jsp(30,4) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f0.setVar("title");
      // /WEB-INF/users.jsp(30,4) name = value type = jakarta.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f0.setValue(new org.apache.jasper.el.JspValueExpression("/WEB-INF/users.jsp(30,4) 'Benutzerverwaltung'",_jsp_getExpressionFactory().createValueExpression("Benutzerverwaltung",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      // /WEB-INF/users.jsp(30,4) name = scope type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/users.jsp(155,24) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setVar("u");
      // /WEB-INF/users.jsp(155,24) name = items type = jakarta.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/users.jsp(155,24) '${users}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${users}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      ...
      try {
        ...
        if (_jspx_eval_c_005fforEach_005f0 != jakarta.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write("                    \n");
            out.write("             <td>");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${u.can_manage_users ?\n 'Ja' : 'Nein'}", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("</td>\n");
            out.write("                                <td>");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${u.can_view_logbook ?\n 'Ja' : 'Nein'}", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("</td>\n");
            out.write("                                <td>");
            ...
            out.write("    \n");
            out.write("                             ");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${u.active ?\n 'Aktiv' : 'Inaktiv'}", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("\n");
            out.write("                            </span>\n");
            out.write("                                </td>\n");
            out.write("                                <td>\n");
            ...
            out.write("\"\n");
            out.write("                                        data-can_manage_users=\"");
            ...
            out.write("\"\n");
            out.write("                                        data-can_manage_feiertage=\"");
            ...
            out.write("\"\n");
            out.write("                                        data-can_view_logbook=\"");
  ...
  private boolean _jspx_meth_c_005fout_005f0(jakarta.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, jakarta.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    try {
      ...
      // /WEB-INF/users.jsp(161,11) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f1(jakarta.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, jakarta.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    try {
      ...
      // /WEB-INF/users.jsp(163,36) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f2(jakarta.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, jakarta.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    try {
      ...
      // /WEB-INF/users.jsp(165,15) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f3(jakarta.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, jakarta.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    try {
      ...
      // /WEB-INF/users.jsp(166,36) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fout_005f3.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${u.stelle}", java.lang.Object.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_005fout_005f4(jakarta.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, jakarta.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    try {
      ...
      // /WEB-INF/users.jsp(167,36) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f5(jakarta.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, jakarta.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    try {
      ...
      // /WEB-INF/users.jsp(173,36) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fout_005f5.setValue((java.lang.Object) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${u.abteilung}", java.lang.Object.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
  ...
  private boolean _jspx_meth_c_005fif_005f0(jakarta.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, jakarta.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    try {
      ...
      // /WEB-INF/users.jsp(176,1) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_c_005fif_005f0 != jakarta.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\n");
          out.write("                                <span title=\"Benutzerkonto\" style=\"margin-right:4px; color:#007bff; vertical-align:middle;\">\n");
          out.write("                                    <svg xmlns=\"http://www.w3.org/2000/svg\" width=\"18\" height=\"18\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\" style=\"vertical-align:middle;\"><path d=\"M20 21v-2a4 4 0 0 0-3-3.87\"/><path d=\"M4 21v-2a4 4 0 0 1 3-3.87\"/><circle \n");
          out.write(" cx=\"12\" cy=\"7\" r=\"4\"/></svg>\n");
          out.write("                                </span>\n");
          out.write("                            ");
  ...
  private boolean _jspx_meth_c_005fif_005f1(jakarta.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, jakarta.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    try {
      ...
      // /WEB-INF/users.jsp(206,36) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_c_005fif_005f1 != jakarta.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          ...
          out.write("                                <form action=\"");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
          out.write("/users/delete\" method=\"post\" style=\"display:inline;\"\n");
  ...
  private boolean _jspx_meth_c_005fif_005f2(jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/users.jsp(225,24) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
