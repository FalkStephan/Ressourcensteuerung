 ...
 * Generated at: 2025-10-27 09:08:58 UTC
...
static {
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                <thead>\n");
      out.write("                    <tr>\n");
      out.write("                        <th class=\"sortable-header\" onclick=\"sortTable(0, 'string')\">Aufgabe</th>\n");
      out.write("                        <th class=\"sortable-header\" onclick=\"sortTable(1, 'string')\">Abteilung</th>\n");
      out.write("                        <th class=\"sortable-header\" onclick=\"sortTable(2, 'number')\">Start</th>\n");
      out.write("                        <th class=\"sortable-header\" onclick=\"sortTable(3, 'number')\">Ende</th>\n");
      out.write("                        <th class=\"sortable-header\" onclick=\"sortTable(4, 'number')\">Aufwand (PT)</th>\n");
      out.write("                        <th class=\"sortable-header\" onclick=\"sortTable(5, 'string')\">Status</th>\n");
      out.write("                        <th class=\"sortable-header\" onclick=\"sortTable(6, 'number')\">Fortschritt (%)</th>\n");
      ...
      out.write("            </table>\n");
      out.write("        </div>\n");
      out.write("        <div id=\"confirmDeleteModal\" class=\"modal-overlay\" style=\"display:none; position:fixed; inset:0; align-items:center; justify-content:center; background:rgba(0,0,0,0.4); z-index:9999;\">\n");
      out.write("            <div class=\"modal-content\" style=\"background:#fff; padding:1.2em; border-radius:6px; width:360px; max-width:90%;\">\n");
      out.write("                <h3 id=\"confirmDeleteTitle\" style=\"margin-top:0;\">Aufgabe löschen</h3>\n");
      out.write("                <p id=\"confirmDeleteMessage\" style=\"margin:0 0 1em 0;\">Soll die Aufgabe <strong <span id=\"confirmDeleteTaskName\"></span> ></strong> wirklich gelöscht werden?</p>\n");
      out.write("                <div style=\"display:flex; gap:0.5em; justify-content:flex-end;\">\n");
      out.write("                    <button type=\"button\" class=\"button delete\" onclick=\"confirmDelete()\" style=\"background:#dc3545; color:#fff;\">Löschen</button>\n");
      out.write("                    <button type=\"button\" class=\"button\" onclick=\"closeDeleteModal()\">Abbrechen</button>\n");
      out.write("                </div>\n");
      out.write("            </div>\n");
      out.write("        </div>\n");
      out.write("    </main>\n");
      ...
      out.write("    let formToDelete = null;\n");
      out.write("\n");
      ...
      out.write("        const table = document.getElementById('taskTable');\n");
      ...
      out.write("\n");
      out.write("\n");
      out.write("    function openDeleteModal(form) {\n");
      out.write("        formToDelete = form;\n");
      out.write("        const name = form.dataset.taskName || form.querySelector('input[name=\"taskId\"]').value;\n");
      out.write("        document.getElementById('confirmDeleteTaskName').textContent = name;\n");
      out.write("        document.getElementById('confirmDeleteModal').style.display = 'flex';\n");
      out.write("    }\n");
      out.write("\n");
      out.write("    function closeDeleteModal() {\n");
      out.write("        formToDelete = null;\n");
      out.write("        document.getElementById('confirmDeleteModal').style.display = 'none';\n");
      out.write("    }\n");
      out.write("\n");
      out.write("    function confirmDelete() {\n");
      out.write("        if (!formToDelete) return;\n");
      out.write("        // Formular abschicken\n");
      out.write("        formToDelete.submit();\n");
      out.write("        // Modal schließen (falls Formular per AJAX gehandhabt wird, ansonsten Seite lädt neu)\n");
  ...
  private boolean _jspx_meth_c_005fset_005f0(jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/tasks.jsp(8,4) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f0.setVar("title");
      // /WEB-INF/tasks.jsp(8,4) name = value type = jakarta.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f0.setValue(new org.apache.jasper.el.JspValueExpression("/WEB-INF/tasks.jsp(8,4) 'Aufgaben'",_jsp_getExpressionFactory().createValueExpression("Aufgaben",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      // /WEB-INF/tasks.jsp(8,4) name = scope type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f0(jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/tasks.jsp(22,73) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/tasks.jsp(25,20) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setVar("status");
      // /WEB-INF/tasks.jsp(25,20) name = items type = jakarta.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/tasks.jsp(25,20) '${taskStatuses}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${taskStatuses}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
  ...
  private boolean _jspx_meth_c_005fout_005f1(jakarta.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f0, jakarta.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f0)
    ...
    try {
      ...
      // /WEB-INF/tasks.jsp(27,28) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f1(jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/tasks.jsp(55,20) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f1.setVar("task");
      // /WEB-INF/tasks.jsp(55,20) name = items type = jakarta.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f1.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/tasks.jsp(55,20) '${tasks}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${tasks}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      ...
      try {
        ...
        if (_jspx_eval_c_005fforEach_005f1 != jakarta.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write("/tasks\" method=\"post\" style=\"display:inline;\" data-task-name=\"");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${fn:escapeXml(task.name)}", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, _jspx_fnmap_0));
            out.write("\">\n");
            ...
            out.write("\">\n");
            out.write("                                    <button type=\"button\" class=\"button small delete\" onclick=\"openDeleteModal(this.closest('form'))\">Löschen</button>\n");
            out.write("                                </form>\n");
            out.write("                            </td>\n");
            out.write("                        </tr>\n");
            out.write("                    ");
  ...
  private boolean _jspx_meth_fmt_005fformatDate_005f0(jakarta.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f1, jakarta.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f1)
    ...
    try {
      ...
      // /WEB-INF/tasks.jsp(59,32) name = type type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fformatDate_005f0.setType("date");
      // /WEB-INF/tasks.jsp(59,32) name = pattern type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_fmt_005fformatDate_005f1(jakarta.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f1, jakarta.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f1)
    ...
    try {
      ...
      // /WEB-INF/tasks.jsp(60,32) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      // /WEB-INF/tasks.jsp(60,32) name = type type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_fmt_005fformatDate_005f1.setType("date");
      // /WEB-INF/tasks.jsp(60,32) name = pattern type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f4(jakarta.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f1, jakarta.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f1)
    ...
    try {
      ...
      // /WEB-INF/tasks.jsp(63,32) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f0(jakarta.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f1, jakarta.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f1)
    ...
    try {
      ...
      // /WEB-INF/tasks.jsp(66,32) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fif_005f0.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${task.task_options == 'waiting'}", boolean.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null)).booleanValue());
      int _jspx_eval_c_005fif_005f0 = _jspx_th_c_005fif_005f0.doStartTag();
      if (_jspx_eval_c_005fif_005f0 != jakarta.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\n");
          out.write("                                    <i class=\"fas fa-hourglass-half\" title=\"Aufgabe wartet auf Verfügbarkeit\" style=\"margin-right: 8px;\"></i>\n");
          out.write("                                ");
  ...
  private boolean _jspx_meth_c_005fif_005f1(jakarta.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f1, jakarta.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f1)
    ...
    try {
      ...
      // /WEB-INF/tasks.jsp(69,32) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fif_005f1.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${task.task_options == 'continue'}", boolean.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null)).booleanValue());
      int _jspx_eval_c_005fif_005f1 = _jspx_th_c_005fif_005f1.doStartTag();
      if (_jspx_eval_c_005fif_005f1 != jakarta.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\n");
          out.write("                                    <i class=\"fas fa-fast-forward\" title=\"Aufgabe fällt auch an, wenn keine Verfügbarkeit vorhanden\" style=\"margin-right: 8px;\"></i>\n");
          out.write("                                ");
  ...
  private boolean _jspx_meth_c_005fif_005f2(jakarta.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f1, jakarta.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f1)
    ...
    try {
      ...
      // /WEB-INF/tasks.jsp(74,32) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fif_005f2.setTest(((java.lang.Boolean) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${not empty task.status_name}", boolean.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null)).booleanValue());
  ...
  private boolean _jspx_meth_c_005fout_005f5(jakarta.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f2, jakarta.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f1)
          throws java.lang.Throwable {
    jakarta.servlet.jsp.PageContext pageContext = _jspx_page_context;
    //  c:out
    ...
    try {
      ...
      // /WEB-INF/tasks.jsp(76,40) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f6(jakarta.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f1, jakarta.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f1)
    ...
    try {
      ...
      // /WEB-INF/tasks.jsp(85,42) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f2(jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/tasks.jsp(227,32) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f2.setVar("user");
      // /WEB-INF/tasks.jsp(227,32) name = items type = jakarta.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f2.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/tasks.jsp(227,32) '${users}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${users}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
  ...
  private boolean _jspx_meth_c_005fout_005f7(jakarta.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f2, jakarta.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f2)
    ...
    try {
      ...
      // /WEB-INF/tasks.jsp(228,63) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
