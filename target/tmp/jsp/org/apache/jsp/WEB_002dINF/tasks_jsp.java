 ...
 * Generated at: 2025-09-09 08:36:28 UTC
...
public final class tasks_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                        Zuweisungen anzeigen\n");
      out.write("                    </label>\n");
      out.write("                </div>\n");
      out.write("            </form>\n");
      out.write("\n");
      ...
      out.write("    let taskAssignments = new Map(); // Speichert die Zuweisungen pro Task\n");
      out.write("\n");
      ...
      out.write("            console.log('Verarbeite Task:', taskId);\n");
      out.write("            \n");
      out.write("            let assignmentsContainer = taskElement.querySelector('.task-assignments');\n");
      out.write("            \n");
      out.write("            if (showAssignments) {\n");
      out.write("                if (!assignmentsContainer) {\n");
      out.write("                    assignmentsContainer = document.createElement('div');\n");
      out.write("                    assignmentsContainer.className = 'task-assignments';\n");
      out.write("                    // Container zur ersten Tabellenzelle hinzufügen\n");
      out.write("                    // taskElement.querySelector('td:first-child').appendChild(assignmentsContainer);\n");
      out.write("                }\n");
      out.write("                \n");
      out.write("                if (taskId) {  // Nur laden wenn taskId vorhanden\n");
      out.write("                    try {\n");
      out.write("                        const assignments = await loadTaskAssignments(taskId);\n");
      out.write("                        // if (assignments && assignments.length > 0) {\n");
      out.write("                        //    const html = assignments.map(assignment => \n");
      out.write("                        //        '<div class=\"task-assignment\">' +\n");
      out.write("                        //           assignment.name + ', ' + assignment.vorname + \n");
      out.write("                        //            ' <span class=\"effort\">(' + assignment.effort_days + ' PT)</span>' +\n");
      out.write("                        //            (assignment.abteilung ? ' <span class=\"department\">' + assignment.abteilung + '</span>' : '') +\n");
      out.write("                        //    '</div>'\n");
      out.write("                        //    ).join('');\n");
      out.write("                        //    assignmentsContainer.innerHTML = html;\n");
      out.write("                        //} else {\n");
      out.write("                        //    assignmentsContainer.innerHTML = '<div class=\"task-assignment\">Keine Zuweisungen</div>';\n");
      out.write("                        // }\n");
      out.write("                        //assignmentsContainer.style.display = 'block';\n");
      out.write("\n");
      out.write("                        if (assignments && assignments.length > 0) {\n");
      out.write("                            // HTML für die verschiedenen Spalten erstellen\n");
      out.write("                            const nameHtml = assignments.map(assignment => \n");
      out.write("                                '<div class=\"assignment-value\">' + assignment.name  + '</span>' + '</div>'\n");
      out.write("                            ).join('');\n");
      out.write("                            \n");
      out.write("                            const vornameHtml = assignments.map(assignment => \n");
      out.write("                                '<div class=\"assignment-value\">'  + assignment.vorname + '</span>' + '</div>'\n");
      out.write("                            ).join('');\n");
      out.write("                            \n");
      out.write("                            const abteilungHtml = assignments.map(assignment => \n");
      out.write("                                '<div class=\"assignment-value\">' + assignment.abteilung  + '</span>' + '</div>'\n");
      out.write("                            ).join('');\n");
      out.write("                            \n");
      out.write("                            const effortHtml = assignments.map(assignment => \n");
      out.write("                                '<div class=\"assignment-value\">' + assignment.effort_days  + '</span>' + '</div>'\n");
      out.write("                            ).join('');\n");
      out.write("                            \n");
      out.write("                            // Werte in die entsprechenden Zellen einfügen\n");
      out.write("                            taskElement.querySelector('td:nth-child(3)').innerHTML = nameHtml;\n");
      out.write("                            taskElement.querySelector('td:nth-child(4)').innerHTML = vornameHtml;\n");
      out.write("                            taskElement.querySelector('td:nth-child(2)').innerHTML = abteilungHtml;\n");
      out.write("                            taskElement.querySelector('td:nth-child(5)').innerHTML = effortHtml;\n");
      out.write("                        }\n");
      out.write("\n");
      out.write("\n");
      out.write("\n");
      ...
      out.write("                        assignmentsContainer.innerHTML = '<div class=\"task-assignment error\">Fehler beim Laden der Zuweisungen</div>';\n");
      out.write("                    }\n");
      out.write("                }\n");
      out.write("            } else if (assignmentsContainer) {\n");
      out.write("                assignmentsContainer.style.display = 'none';\n");
      out.write("            \n");
      out.write("\n");
      out.write("            } else {\n");
      out.write("                // Ursprüngliche Werte wiederherstellen\n");
      out.write("                console.log('Ursprüngliche Werte', taskId);\n");
      out.write("                taskElement.querySelector('td:nth-child(3)').innerHTML = originalValues.start;\n");
      out.write("                taskElement.querySelector('td:nth-child(4)').innerHTML = originalValues.end;\n");
      out.write("                taskElement.querySelector('td:nth-child(2)').innerHTML = originalValues.abteilung;\n");
      out.write("                taskElement.querySelector('td:nth-child(5)').innerHTML = originalValues.effort;\n");
      out.write("\n");
      out.write("            }\n");
      out.write("        }\n");
      out.write("    }\n");
      out.write("\n");
      out.write("    // Initial aufrufen\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f2(jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/tasks.jsp(156,32) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f2.setVar("user");
      // /WEB-INF/tasks.jsp(156,32) name = items type = jakarta.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f2.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/tasks.jsp(156,32) '${users}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${users}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
  ...
  private boolean _jspx_meth_c_005fout_005f7(jakarta.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f2, jakarta.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f2)
    ...
    try {
      ...
      // /WEB-INF/tasks.jsp(157,63) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
