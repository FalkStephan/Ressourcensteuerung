 ...
 * Generated at: 2025-09-09 16:00:54 UTC
...
public final class tasks_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final jakarta.servlet.http.HttpServletRequest request, final jakarta.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                                newRow.className = 'task-assignment-row'; // Eine Klasse zum einfachen Finden und Entfernen\n");
      out.write("\n");
      out.write("                                // HTML für die neue Zeile mit den Zuweisungsdaten in den richtigen Spalten\n");
      out.write("                                newRow.innerHTML = `\n");
      out.write("                                    <td></td> <td><div class=\"assignment-value\">");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${assignment.abteilung || ''}", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("</div></td>\n");
      out.write("                                    <td><div class=\"assignment-value\">");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${assignment.name || ''}", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("</div></td>\n");
      out.write("                                    <td><div class=\"assignment-value\">");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${assignment.vorname || ''}", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("</div></td>\n");
      out.write("                                    <td><div class=\"assignment-value\">");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${assignment.effort_days || ''}", java.lang.String.class, (jakarta.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("</div></td>\n");
      out.write("                                    <td></td> <td></td> <td></td> `;\n");
      out.write("\n");
      out.write("                                // Füge die neue Zeile nach dem Task-Element oder der letzten Zuweisungszeile ein\n");
      out.write("                                lastElement.parentNode.insertBefore(newRow, lastElement.nextSibling);\n");
      out.write("                                lastElement = newRow; // Aktualisiere das letzte Element für die nächste Iteration\n");
      out.write("                            });\n");
      out.write("                        }\n");
      out.write("                    } catch (error) {\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f2(jakarta.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/tasks.jsp(157,32) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f2.setVar("user");
      // /WEB-INF/tasks.jsp(157,32) name = items type = jakarta.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f2.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/tasks.jsp(157,32) '${users}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${users}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
  ...
  private boolean _jspx_meth_c_005fout_005f7(jakarta.servlet.jsp.tagext.JspTag _jspx_th_c_005fforEach_005f2, jakarta.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_c_005fforEach_005f2)
    ...
    try {
      ...
      // /WEB-INF/tasks.jsp(158,63) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
